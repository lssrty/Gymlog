 ...
 * @version 2021.03.27 14:38:37 // Generated by ComTest
 *
 */
...
public class SaliTest {
   ...
   */
  @Test
  public void testPoista186() throws Exception {    // Sali: 186
    alustaSali(); 
    assertEquals("From: Sali line: 189", 2, sali.getSuorituksia()); 
    assertEquals("From: Sali line: 190", 1, sali.poista(kyykkysarja1)); 
    assertEquals("From: Sali line: 191", 1, sali.getSuorituksia()); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** 
   * testAnnaSuoritukset218 
   * @throws SailoException when error
   */
  @Test
  public void testAnnaSuoritukset218() throws SailoException {    // Sali: 218
    Sali sali = new Sali(); 
    ...
    assertEquals("From: Sali line: 235", 0, loytyneet.size()); 
    loytyneet = sali.annaSuoritukset(treeni1); 
    assertEquals("From: Sali line: 237", 2, loytyneet.size()); 
    assertEquals("From: Sali line: 238", true, loytyneet.get(0) == kyykky11); 
    assertEquals("From: Sali line: 239", true, loytyneet.get(1) == kyykky12); 
    loytyneet = sali.annaSuoritukset(treeni2); 
    assertEquals("From: Sali line: 241", 3, loytyneet.size()); 
    assertEquals("From: Sali line: 242", true, loytyneet.get(0) == kyykky21); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** 
   * testLueTiedostosta290 
   * @throws SailoException when error
   */
  @Test
  public void testLueTiedostosta290() throws SailoException {    // Sali: 290
    Sali sali = new Sali(); 
    ...
    assertEquals("From: Sali line: 330", kyykky1.toString(), it.next().toString()); 
    assertEquals("From: Sali line: 331", kyykky2.toString(), it.next().toString()); 
    assertEquals("From: Sali line: 332", false, it.hasNext()); 
    List<Suoritus> loytyneet = sali.annaSuoritukset(reeni1); 
    Iterator<Suoritus> ih = loytyneet.iterator(); 
    assertEquals("From: Sali line: 335", kyykky1.toString(), ih.next().toString()); 
    assertEquals("From: Sali line: 336", kyykky2.toString(), ih.next().toString()); 
    assertEquals("From: Sali line: 337", false, ih.hasNext()); 
    loytyneet = sali.annaSuoritukset(reeni2); 
    ih = loytyneet.iterator(); 
    assertEquals("From: Sali line: 340", kyykky3.toString(), ih.next().toString()); 
    assertEquals("From: Sali line: 341", kyykky4.toString(), ih.next().toString()); 
    assertEquals("From: Sali line: 342", false, ih.hasNext()); 
    sali.lisaa(reeni2); 
    sali.lisaa(kyykky4); 
    Liike kulmasoutu = new Liike(); kulmasoutu.rekisteroi(); kulmasoutu.setLiikeNimi("kulmasoutu"); 
    sali.lisaa(kulmasoutu); 
    sali.tallenna(); 
    assertEquals("From: Sali line: 348", true, fhtied.delete()); 
    assertEquals("From: Sali line: 349", true, fltied.delete()); 
    assertEquals("From: Sali line: 350", true, fstied.delete()); 
    ...
    assertEquals("From: Sali line: 354", true, fhbak.delete()); 
    flbak.delete();  // === true;
    assertEquals("From: Sali line: 356", true, fsbak.delete()); 
    assertEquals("From: Sali line: 357", true, dir.delete()); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testOnkoLiike435() throws SailoException {    // Sali: 435
    Sali sali = new Sali(); 
    Liike kyykky = new Liike(), penkki = new Liike(); 
    kyykky.rekisteroi(); penkki.rekisteroi(); 
    kyykky.setLiikeNimi("kyykky"); 
    penkki.setLiikeNimi("penkki"); 
    sali.lisaa(kyykky); sali.lisaa(penkki); 
    assertEquals("From: Sali line: 443", false, sali.onkoLiike("petteri")); 
    assertEquals("From: Sali line: 444", true, sali.onkoLiike("kyykky")); 
  } // Generated by ComTest END
}